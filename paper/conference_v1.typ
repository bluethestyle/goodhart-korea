...
= 방법론
  ...
  #figure(
    table(
      ...
      table.hline(y: 1, stroke: 1.0pt + black),
      [*도구*], [*역할*], [*가정*], [*약점*],
      [FFT (amp_12m)], [게임화 강도 1차 측정], [정상성·주기 일정], [추세 흡수·경계 효과],
