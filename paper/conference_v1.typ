...
= 서론
  ...
  한국 재정에서 연말 집행 쏠림·불용·이월은 오래 다뤄진 주제다. 그러나 기존 논의는 대체로 "불용은 비효율, 집행률은 성과"라는 관리·효율 관점에 서 있으며, 표준 처방도 조기집행·신속집행으로 집행률을 높여 불용을 줄이는 방향을 향한다(양인용·배기수, 2019; 양지숙·오현주, 2020; 한국재정정보원, 2022). 본 연구의 관점은 이와 상반된다 — 집행률을 평가지표로 강조하는 것 자체가 모형의 시점 가중 $w_t$를 키워 12월 게임화를 유발하는 원인이며, 집행률 제고를 향한 표준 처방은 게임화를 완화하기보다 강화하는 방향으로 작동할 수 있다. 측정 게임화·다업무 계약의 관점에서 한국 재정 집행을 분석한 연구는 드물며, 본 연구는 잘 알려진 현상을 이 관점으로 재정의해 표준 처방의 역설을 드러낸다.
