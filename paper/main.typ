...
#figure(
  ...
  caption: [12개월 cycle 진폭의 연도별 진화 — 출연금형 5.5배 증폭, 인건비형 변화 없음(통제). 정책 변화점 (2017 국가재정법 시행 후 10년, 2020 COVID 확장재정) annotate.],
) <fig-h28-evol-body>
